...
public abstract class UserApp implements Parcelable {
    ...
    public static UserApp create(String id, String name, String email, String providerId) {
        return new AutoValue_UserApp(id, name, email, providerId);
    }

    public static UserApp create(UserAppDomain uad) {
        return new AutoValue_UserApp(uad.id(), uad.name(), uad.email(), uad.providerId());
    }
